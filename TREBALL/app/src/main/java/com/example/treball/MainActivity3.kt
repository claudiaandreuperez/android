...
import com.example.treball.databinding.ActivityMain3Binding


class MainActivity3 : AppCompatActivity() {
    private lateinit var binding: ActivityMain3Binding
    private var jugadors_brazil_mutable:MutableList<Jugador> = JugadorProvider.jugadors_brazil.toMutableList()
    ...
    private fun initRecycleView(){
        ...
        recyclerView.adapter = JugadorAdapter(JugadorProvider.jugadors_brazil)
    ...
    fun addjugador(): List<Jugador> {
        ...
        jugadors_brazil_mutable.add(index = 1, Jugador(jugadornou.foto, jugadornou.nom, jugadornou.edat, jugadornou.altura, jugadornou.pes, jugadornou.equip))
        Log.i("---->",jugadors_brazil_mutable.toString())
        return  jugadors_brazil_mutable
