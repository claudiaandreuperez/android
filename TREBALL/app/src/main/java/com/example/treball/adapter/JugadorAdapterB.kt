...
class JugadorAdapterB(val jugadors_brazil: List<Jugador>): RecyclerView.Adapter<JugadorViewHolder>() {
    ...
    override fun onBindViewHolder(holder: JugadorViewHolder, position: Int) {
        val item = jugadors_brazil[position]
        val foto = item.foto
        val nom = item.nom
        val edat = item.edat
